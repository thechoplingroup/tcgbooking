    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="max-w-md mx-auto mt-16 px-4">
          <div className="bg-white rounded-2xl border border-[#e8e2dc] p-8 text-center">
            <div className="w-14 h-14 rounded-full bg-[#f5ede8] flex items-center justify-center mx-auto mb-5">
            ...
            <p className="text-sm text-[#8a7e78] mb-6 leading-relaxed">
              An unexpected error occurred. Try refreshing the page — if it keeps happening, contact support.
            </p>
            {process.env.NODE_ENV === "development" && this.state.error && (
              <pre className="text-xs text-left text-red-600 bg-red-50 border border-red-200 rounded-xl p-4 max-w-sm mx-auto overflow-auto mb-4">
